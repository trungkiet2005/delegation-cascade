...
a delegation chain accountable in practice. The Agent Control
...
what depth caps buy. The right figure of merit for an accountability protocol
...
small-mutation limit itself, which Section~\ref{sec:robustness} checks against
